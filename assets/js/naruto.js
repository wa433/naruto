...
$(document).ready(function() {
	...
	$('.flexslider').flexslider({
			directionNav: false,
			slideshowSpeed: 3000, /* adjust the speed in milliseconds */
			useCSS: true,
			touch: false, // touch: true needs user to slide touch the testimonial item
			controlNav: false,
			pauseOnAction: true,
			pauseOnHover: false
	...
	// init carousels, only on min 768px screen width
	if( $(window).width() >= 768 ) {
		$('.carousel').carousel();
	}	
